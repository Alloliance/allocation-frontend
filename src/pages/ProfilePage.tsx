  ...
  return (
    <PageContainer classes={getTranslateClass()} showSecondBlob>
      ...
      <div className="flex flex-col  h-full w-full mx-auto">
        <h1 className="text-6xl text-right font-lato text-pink-400 text-shadow-neon mx-4">
          PROFILE
        </h1>
        <div className="text-pink-50 mx-4">
          <div className="md:bg-black-transparent bg-pink-500 rounded-lg text-white pt-8 pb-4 px-8  flex flex-col-reverse  md:flex-row gap-2">
            ...
            <div className=" w-92 md:m-10 md:my-auto mb-0 flex flex-col md:items-center items-end md:relative md:bottom-6">
              <img
